        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={coda}
              isBlog={false}
              title="CODA - 3D reconstruction"
              description="CODA, a method to reconstruct exceptionally large tissues at subcellular resolution using serially sectioned hematoxylin and eosin-stained tissue sections."
              ghLink="https://github.com/FertigLab/PanIN_carcinogeneisis_spatial_analysis"
